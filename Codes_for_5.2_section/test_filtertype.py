...
IN_FEAT = 20531
##### change label types
#OUT_FEAT = 37    # total labels
OUT_FEAT = 34    # delete KICH, KIRC, KIRP
...
for x in range(values_len):
    ...
    #if label != "KICH" and label != "KIRC" and label != "KIRP":
    if label != "KICH" and label != "KIRC" and label != "KIRP" and label != "READ" and label != "STES" and label != "LGG" and label != "COADREAD":
       features.append(feature)    
       label_idx.append(types_lst.index(label))
    
    # print the specifical samples (feature + label) 
    # if label == "STES":
...
X_train, X_test, y_train, y_test = train_test_split(
    features_np, label_idx_np, test_size=0.2, random_state=35
)
print(len(X_train))
print(len(X_test))
# print(y_test)
