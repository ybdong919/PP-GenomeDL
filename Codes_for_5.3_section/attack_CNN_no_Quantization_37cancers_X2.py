'''
Model class delete two dropout layers and one Maxpool layer
'''
import datetime
import os
import random
...
def Attack(mynet, target_label,device):
    ...
    target_output = torch.zeros(1, 37)
...
class Model(nn.Module):
    def __init__(self, input_size, num_classes):
        ...
        self.fc = nn.Linear(
            ...
            ### if delete maxpool2d layer in the model
            in_features=6*shape_conv1_w*shape_conv1_h,
...
### (2) all 37 cancer types                   
cancerTypes = ['ACC', 'BLCA', 'BRCA', 'CESC', 'CHOL', 'COAD', 'DLBC', 'ESCA', 'GBMLGG', 'HNSC',
                'KIPAN', 'LAML', 'LIHC', 'LUAD', 'LUSC', 'MESO', 'OV', 'PAAD', 'PCPG',
                   'PRAD', 'SARC', 'SKCM', 'STAD', 'TGCT', 'THCA', 'THYM', 'UCEC', 'UCS', 'UVM', 'KICH', 'KIRC', 'KIRP', 'COADREAD', 'READ', 'LGG', 'STES', 'GBM']
