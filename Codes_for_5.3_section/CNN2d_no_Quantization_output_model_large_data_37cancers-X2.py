'''
The script is revised based on CNN2d_no_Quantization_output_model_small_data_37cancers.py.
All revised lines are marked as (1)--(4)
'''
import time
import numpy as np
import copy
...
def save_checkpoint(model, is_best):
    ### (4)
    expname = "CNN2d_no_Quantization_largedata_37cancers_X2"
